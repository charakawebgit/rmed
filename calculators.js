...
export const commonUnitConfigs = {
  ...
  serumCreatinine: {
    ...
    supportedUnits: [
      ...
      { value: 'umol/L', label: 'µmol/L', toBaseFactor: UMOL_L_TO_MG_DL_CREATININE },
    ],
  },
  albumin: {
    defaultUnit: 'g/dL',
  ...
  bilirubin: {
    ...
    supportedUnits: [
      { value: 'mg/dL', label: 'mg/dL', toBaseFactor: 1 },
      { value: 'umol/L', label: 'µmol/L', toBaseFactor: UMOL_L_TO_MG_DL_BILIRUBIN },
    ],
  },
  sodiumMeqL: {
    defaultUnit: 'mEq/L',
...
export const calculators = [
  ...
  },
  {
    ...
    resultLabel: 'LA Classification Grade',
    resultUnit: '',
    details: {
